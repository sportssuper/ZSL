...
|**Article title**|**Author(s)**|**Journal**|**Impact factor**|
|------------|------|-----|-----|
|**[Seasonal dynamics of stress perception and coping strategies among Chinese elite Basketball referees ]([https://doi.org/10.1080/02640414.2018.1466493](https://doi.org/10.1080/02640414.2025.2536426))**|Zhai, Z., Li, L., Chen, J., & **Zhang, S.**| **Journal of Sports Sciences**|**<span style="background-color: #960DBD; color: white; padding: 1px 4px;"> 中科院3区, JCR: Q2, IF:2.5</span>**|
